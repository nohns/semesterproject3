...
#define pump_timer_1_Resolution                 16u
#define pump_timer_1_UsingFixedFunction         1u
...
#define pump_timer_1_INIT_PERIOD             59999u
...
***************************************/
    ...
    ***************************************/
    ...
    #define pump_timer_1_CONTROL             (* (reg8 *) pump_timer_1_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__CONTROL_REG )
        ...
        #define pump_timer_1_CAPTURE_LSB         (* (reg8 *) pump_timer_1_TimerUDB_sT16_timerdp_u0__F0_REG )
        #define pump_timer_1_CAPTURE_LSB_PTR       ((reg8 *) pump_timer_1_TimerUDB_sT16_timerdp_u0__F0_REG )
        #define pump_timer_1_PERIOD_LSB          (* (reg8 *) pump_timer_1_TimerUDB_sT16_timerdp_u0__D0_REG )
        #define pump_timer_1_PERIOD_LSB_PTR        ((reg8 *) pump_timer_1_TimerUDB_sT16_timerdp_u0__D0_REG )
        #define pump_timer_1_COUNTER_LSB         (* (reg8 *) pump_timer_1_TimerUDB_sT16_timerdp_u0__A0_REG )
        #define pump_timer_1_COUNTER_LSB_PTR       ((reg8 *) pump_timer_1_TimerUDB_sT16_timerdp_u0__A0_REG )
    #elif(pump_timer_1_Resolution <= 16u) /* 8-bit Timer */
        #if(CY_PSOC3) /* 8-bit addres space */
            #define pump_timer_1_CAPTURE_LSB         (* (reg16 *) pump_timer_1_TimerUDB_sT16_timerdp_u0__F0_REG )
            #define pump_timer_1_CAPTURE_LSB_PTR       ((reg16 *) pump_timer_1_TimerUDB_sT16_timerdp_u0__F0_REG )
            #define pump_timer_1_PERIOD_LSB          (* (reg16 *) pump_timer_1_TimerUDB_sT16_timerdp_u0__D0_REG )
            #define pump_timer_1_PERIOD_LSB_PTR        ((reg16 *) pump_timer_1_TimerUDB_sT16_timerdp_u0__D0_REG )
            #define pump_timer_1_COUNTER_LSB         (* (reg16 *) pump_timer_1_TimerUDB_sT16_timerdp_u0__A0_REG )
            #define pump_timer_1_COUNTER_LSB_PTR       ((reg16 *) pump_timer_1_TimerUDB_sT16_timerdp_u0__A0_REG )
        #else /* 16-bit address space */
            #define pump_timer_1_CAPTURE_LSB         (* (reg16 *) pump_timer_1_TimerUDB_sT16_timerdp_u0__16BIT_F0_REG )
            #define pump_timer_1_CAPTURE_LSB_PTR       ((reg16 *) pump_timer_1_TimerUDB_sT16_timerdp_u0__16BIT_F0_REG )
            #define pump_timer_1_PERIOD_LSB          (* (reg16 *) pump_timer_1_TimerUDB_sT16_timerdp_u0__16BIT_D0_REG )
            #define pump_timer_1_PERIOD_LSB_PTR        ((reg16 *) pump_timer_1_TimerUDB_sT16_timerdp_u0__16BIT_D0_REG )
            #define pump_timer_1_COUNTER_LSB         (* (reg16 *) pump_timer_1_TimerUDB_sT16_timerdp_u0__16BIT_A0_REG )
            #define pump_timer_1_COUNTER_LSB_PTR       ((reg16 *) pump_timer_1_TimerUDB_sT16_timerdp_u0__16BIT_A0_REG )
        #endif /* CY_PSOC3 */
    #elif(pump_timer_1_Resolution <= 24u)/* 24-bit Timer */
        #define pump_timer_1_CAPTURE_LSB         (* (reg32 *) pump_timer_1_TimerUDB_sT16_timerdp_u0__F0_REG )
        #define pump_timer_1_CAPTURE_LSB_PTR       ((reg32 *) pump_timer_1_TimerUDB_sT16_timerdp_u0__F0_REG )
        #define pump_timer_1_PERIOD_LSB          (* (reg32 *) pump_timer_1_TimerUDB_sT16_timerdp_u0__D0_REG )
        #define pump_timer_1_PERIOD_LSB_PTR        ((reg32 *) pump_timer_1_TimerUDB_sT16_timerdp_u0__D0_REG )
        #define pump_timer_1_COUNTER_LSB         (* (reg32 *) pump_timer_1_TimerUDB_sT16_timerdp_u0__A0_REG )
        #define pump_timer_1_COUNTER_LSB_PTR       ((reg32 *) pump_timer_1_TimerUDB_sT16_timerdp_u0__A0_REG )
    #else /* 32-bit Timer */
            ...
            #define pump_timer_1_CAPTURE_LSB         (* (reg32 *) pump_timer_1_TimerUDB_sT16_timerdp_u0__32BIT_F0_REG )
            #define pump_timer_1_CAPTURE_LSB_PTR       ((reg32 *) pump_timer_1_TimerUDB_sT16_timerdp_u0__32BIT_F0_REG )
            #define pump_timer_1_PERIOD_LSB          (* (reg32 *) pump_timer_1_TimerUDB_sT16_timerdp_u0__32BIT_D0_REG )
            #define pump_timer_1_PERIOD_LSB_PTR        ((reg32 *) pump_timer_1_TimerUDB_sT16_timerdp_u0__32BIT_D0_REG )
            #define pump_timer_1_COUNTER_LSB         (* (reg32 *) pump_timer_1_TimerUDB_sT16_timerdp_u0__32BIT_A0_REG )
            #define pump_timer_1_COUNTER_LSB_PTR       ((reg32 *) pump_timer_1_TimerUDB_sT16_timerdp_u0__32BIT_A0_REG )
        #endif /* CY_PSOC3 || CY_PSOC5 */ 
    #endif

    #define pump_timer_1_COUNTER_LSB_PTR_8BIT       ((reg8 *) pump_timer_1_TimerUDB_sT16_timerdp_u0__A0_REG )
