...
*
* \funcusage
*  \snippet debug_led_SUT.c usage_debug_led_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet debug_led_SUT.c usage_debug_led_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet debug_led_SUT.c usage_debug_led_Read  
*******************************************************************************/
...
* preferred debug_led_Read() API because the 
* debug_led_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet debug_led_SUT.c usage_debug_led_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: debug_led_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use debug_led_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - debug_led_0_INTR       (First pin in the list)
    *  - debug_led_1_INTR       (Second pin in the list)
    *  - ...
    *  - debug_led_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet debug_led_SUT.c usage_debug_led_SetInterruptMode
    *******************************************************************************/
    void debug_led_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & debug_led_0_INTR) != 0u) 
		{ 
			 debug_led_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet debug_led_SUT.c usage_debug_led_ClearInterrupt
    *******************************************************************************/
